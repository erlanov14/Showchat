...
- (void)addGradients {
    [self addToView:_grV3 size:CGRectMake(0, 0, Scn_Width/(2.65/1.65), Scn_Height*0.6 - 1)];
    [self addToView:_grV2 size:CGRectMake(0, 0, Scn_Width/(2.65), Scn_Height*0.3)];
    [self addToView:_grV1 size:CGRectMake(0, 0, Scn_Width/(2.65), Scn_Height*0.3)];
}
